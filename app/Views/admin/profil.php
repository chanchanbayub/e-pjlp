            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Data Profil Pengguna</h3>
                        <div class="box-tools pull-right">
                            <a href="/pjlp/admin/edit-profil/<?= $profil["userid"]; ?>"> <i class="fa fa-arrow-left"> Edit Data Users </i></a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 ">
                                        ...
                                        <?php if ($profil["image"] == null) : ?>
                                            <form action="/pjlp/admin/saveImage/<?= session("userid"); ?>" method="post" enctype="multipart/form-data">
                                                <div class="input-group <?= ($validation->hasError('image')) ? 'has-error' : ''; ?>">
                                                    <input type="hidden" name="userid_image" id="userid_image" value="<?= session('userid'); ?>">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <?php if ($profil["Privilege"] == 2) : ?>
                                                    Kepala Seksi
                                                <?php elseif ($profil["Privilege"] == 14) :  ?>
                                                    Admin
                                                <?php elseif ($profil["Privilege"] == 12) : ?>
                                                    Kepala Bidang
                                                <?php endif; ?>
                                            </div>
                                        </div>
